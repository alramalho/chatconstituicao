...
const DATA_FILENAME = process.env.CODIGO_CIVIL_DATA_FILENAME ?? "codigo-civil.ts";
const SKIP_PDF = process.env.CODIGO_CIVIL_SKIP_PDF === "1";
...
const dataPath = resolve(ROOT, `apps/api/src/data/codigo-civil/${DATA_FILENAME}`);
writeFileSync(
  dataPath,
  `// Generated by tools/build-codigo-civil.mjs. Do not edit manually.\nimport type { LegalDocument } from "../types.js";\n\nexport const CODIGO_CIVIL_SOURCE = ${tsString({
    title: "Código Civil Português",
    sourceUrl: SOURCE_URL,
    sourceVersion: SOURCE_VERSION,
    generatedAt: new Date().toISOString(),
    articleCount: uniqueArticles.length,
  })} as const;\n\nexport const CODIGO_CIVIL: LegalDocument = ${tsString(document)};\n`
);
